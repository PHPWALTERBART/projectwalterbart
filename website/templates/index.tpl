		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				$('#clickblog').click(function() {
					$('#clickblog').fadeOut('fast', function() {
						$('#blogcomment').fadeIn("slow");
					});
				});
				$('#backto').click(function() {
					$('#blogcomment').fadeOut('fast', function() {
						$('#clickblog').fadeIn('slow');
					});
				});
		...
		<div id="container">
			...
			<div id="inlogdiv">
				...
				<div id="logingform">
					...
					<label for="inlognaam">username: </label><input type="text" name="inlog[]" id="inlognaam">
					<br>				
					<label for="wachtwoord">wachtwoord: </label><input type="password" name="inlog[]" id="wachtwoord">
					<br>
					<input type="submit" value="login" name="post2">
				</form>
				</div>
			...
			<div id="cont5" class='content'>
				...
				<div id="clickblog" class='clickblog'>
					<p>klik voor comment</p>
				</div>
				<div id="blogcomment" class="blogcomment">
					<form  action="proces.php" method="post">
						<label for="blogname">naam: </label><input type="text" name="blogname" id="blogname" placeholder="uw naam"></br>
						<textarea name="contenttext" rows='8' cols='35' id='area2'placeholder="wat vond u van deze post"></textarea></br>
						<input type="submit" value="post" name="post2">
						<div id="backto">
							<p>back</p>
						</div>
					</form>
